...
newNav2.textContent = "last one";

const wholeNav = document.querySelector("nav");

wholeNav.prepend(newNav1);
wholeNav.append(newNav2);

const buttonClick = (document.querySelector(
  ".cta-text button"
).buttonClick = function () {
  document.querySelector(".cta-text button").style.backgroundColor = "Blue";
});
buttonClick.createElement;
